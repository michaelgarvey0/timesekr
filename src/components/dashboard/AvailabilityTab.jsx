    ...
    <div>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
        ...
        {connectedCalendars.length === 0 ? (
          <p className="text-gray-600 text-sm mb-4">No calendars connected yet</p>
        ) : (
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Connect a Calendar</h3>
        <p className="text-sm text-gray-600 mb-4">
          Connect your personal calendar to automatically share your availability
        </p>

        <div className="space-y-3">
          <button
            onClick={() => handleConnectCalendar('google')}
            className="w-full flex items-center justify-between p-3 border-2 border-gray-200 rounded-lg hover:border-teal-500 hover:bg-teal-50 transition"
          >
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white rounded shadow flex items-center justify-center">
                <svg className="w-5 h-5" viewBox="0 0 24 24">
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-gray-500">Connect your personal Google Calendar</div>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-gray-500">Connect your personal Outlook Calendar</div>
              </div>
            </div>
            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-gray-500">Connect your personal Apple Calendar</div>
              </div>
            </div>
            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
