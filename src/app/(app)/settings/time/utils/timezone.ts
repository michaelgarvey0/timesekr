...
/**
 * Get a list of all IANA timezone identifiers
 * Uses Intl.supportedValuesOf if available (modern browsers), otherwise falls back to a comprehensive list
 */
...
/**
 * Format timezone for display (e.g., "America/New_York" -> "New York (America/New_York)")
 */
