        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            <Box sx={{ maxWidth: 480 }}>
              ...
              <Typography
                variant='h1'
                sx={{ mt: 2, fontWeight: 800, fontSize: '3xl' }}
              >
                {planner.name}
              </Typography>
              <Box sx={{ mt: 2, display: 'flex', alignItems: 'center' }}>
                <Typography sx={{ color: 'gray.800', fontSize: 'xl' }}>
                  {planner.price}
                </Typography>
                <Box
                  sx={{ ml: 2, pl: 2, borderLeft: 1, borderColor: 'divider' }}
                >
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Typography
                      sx={{ ml: 1, color: 'gray.500', fontWeight: 500 }}
                    >
