...
export function ChangelogFeed({ entries }: { entries: ChangelogFeedItem[] }) {
  return (
    <>
      {entries.map((entry: ChangelogFeedItem, index: number) => (
        <>
          <Box
...
function ChangelogFeedDate({ date }: { date: string }) {
