...
import { DataGrid, DataGridProps, GridSortDirection, gridClasses } from '@mui/x-data-grid';
import * as React from 'react';

import { DotLoader } from '~/components/DotLoader';

export const defaultAscendingSortOrder = ['asc', 'desc', null] as GridSortDirection[];
export const defaultDescendingSortOrder = ['desc', 'asc', null] as GridSortDirection[];
